...
<div class="container">
    <div class="row">
        <div class="col-md-offset-5 col-md-3">
            ...
            echo form_open('inicio/login', $attributes);?>               
            <br><br><br><br><br>
                ...
                <div class="form-group input-group">
                    ...
                    <input required onselectstart="return false;" ondragstart="return false;" type="text" id="userName" name="userName" class="form-control" placeholder="username" onkeypress="if (event.keyCode == 13) enviar_formulario()"/>
                </div>

                <div class="form-group input-group">
                    <span class="input-group-addon"><i class="fa fa-key fa-fw"></i></span>
                    <input required onselectstart="return false;" ondragstart="return false;" type="password" id="userPassword" name="userPassword" class="form-control" placeholder="password" onkeypress="if (event.keyCode == 13) enviar_formulario()"/>
                </div>
                ...
                <span class="group-btn">     
                    ...
                    <a href="#" id="login" class="btn btn-primary">Iniciar Sesi&oacute;n <i class="fa fa-sign-in"></i></a>
                </span>
                <br>
                <span class="group-btn">     
                    <!--<button class="btn btn-primary">login <i class="fa fa-sign-in"></i></button>-->
                    <a href="<?=base_url()?>inicio/resetpasswd" id="passwd" >Olvidé mi  Contraseña <i class="fa fa-sign-in"></i></a>
                </span>
