<!-- /. NAV TOP  -->
        ...
        <li class="text-center">
            <img src="<?=base_url()?>images/user.png" class="user-image img-responsive"/>
            ...
            <?}?>-->
                   	...
                   	<li>
                        <a  href="<?=base_url()?>public_version"><i class="fa fa-dashboard fa-3x"></i>Inicio</a><!--Dashboard-->
                    </li>                  
                    <!--<li>
                        <a  href="<?=base_url()?>upload"><i class="fa fa-desktop fa-3x"></i> Subir Im&aacute;genes </a>
                    </li>-->
                    <li>
                        <a  href="<?=base_url()?>public_version/galleria"><i class="fa fa-qrcode fa-3x"></i>Galer&iacute;a</a>
                    </li>
               <li>
                        <a  href="<?=base_url()?>inicio"><i class="fa fa-bar-chart-o fa-3x"></i>Iniciar Sesión</a>
                    </li> 
                     <!-- <li  >
